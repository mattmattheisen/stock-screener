"""Restore rolling breadth-contributor metadata from a GitHub Release."""
...
def main(
    ...
    *,
    restorer: StaticBreadthContributorMetadataReleaseRestorer | None = None,
) -> int:
    ...
    resolved_restorer = restorer or StaticBreadthContributorMetadataReleaseRestorer(
