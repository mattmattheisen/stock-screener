...
_SE_PAYLOADS: dict[str, dict[str, Any]] = {
    ...
    "MSFT": {
        ...
        "base_length_weeks": 16.0,
        "base_depth_pct": 24.0,
        "support_tests_count": 1,
    ...
    "GOOGL": {
        ...
        "in_early_zone": True,
        "extended_from_pivot": False,
        "base_length_weeks": 8.0,
        "base_depth_pct": 11.0,
        "support_tests_count": 3,
        "tight_closes_count": 5,
        "atr14_pct": 4.0,
        "atr14_pct_trend": 0.3,
        "bb_width_pct": 3.0,
